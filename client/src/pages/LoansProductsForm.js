...
function LoansProductsForm({ id: propId, isWindowMode = false }) {
    ...
    try {
      ...
      if (formMode === 'create') {
        ...
        setForm({
          ...
          productType: createdProduct.productType || "Loan",
        ...
        if (!isWindowMode) {
          history.push(`/loans-products/${createdProduct.id}`);
        }
...
export default LoansProductsForm;
